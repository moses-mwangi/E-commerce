        ...
        <div className="col-span-1 p-4 bg-white dark:bg-gray-800 rounded shadow-md">
          ...
          <div className="flex flex-col gap-3">
            ...
            <details className="border-b pb-2">
              ...
              <div className="flex flex-col gap-2 mt-2">
                <label className="flex items-center">
                  <input type="checkbox" className="mr-2" /> Delivery by Mar 08
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="mr-2" /> Delivery by Mar 14
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="mr-2" /> Delivery by Mar 20
                </label>
              </div>
            </details>
          </div>
