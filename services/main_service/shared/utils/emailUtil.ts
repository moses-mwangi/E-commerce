import { OrderTypes } from "../../modules/order/dtos/orderTypes";
import { PaymentTypes } from "../../modules/payments/dtos/paymentTypes";

export const orderEmailMessage = (order: Partial<OrderTypes>) => {
  return `
    <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; padding: 0; background: #f9fafb; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); border: 1px solid #eaeaea;">
      ...
      <div style="background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); padding: 25px 20px; text-align: center; color: white;">
        ...
        <p style="opacity: 0.9; margin: 8px 0 0; font-size: 16px;">ORDER-#${
          order.id
        }</p>
      </div>
        ...
        <div style="background: #f8fafc; border-radius: 8px; padding: 20px; margin: 20px 0; border: 1px solid #e2e8f0;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            <tr>
              ...
              <td style="padding: 8px 0; text-align: right; font-weight: 600; color: #1e293b;">KES ${
                order.totalPrice
              }</td>
            </tr>
            <tr>
...
export const accountEmailMessage = (user: any) => {
  return `
            ...
            <div style="background: #f8fafc; border-radius: 8px; padding: 16px; margin: 20px 0; border: 1px solid #e2e8f0;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; color: #1e293b; font-weight: 500;">${new Date().toLocaleDateString(
                    "en-US",
                    {
                      weekday: "long",
                      year: "numeric",
...
export const paymentEmailMessage = (order: Partial<PaymentTypes>) => {
  return `
        ...
        <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; padding: 0; background: #f9fafb; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); border: 1px solid #eaeaea;">
          <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 30px 20px; text-align: center; color: white; position: relative;">
            ...
            <p style="opacity: 0.9; margin: 8px 0 0; font-size: 16px; font-weight: 400;">
              Order #${
                order.order?.trackingNumber?.slice(0, 12) || "ORD-XXXXXX"
              }
            </p>
          </div>
          ...
          <div style="padding: 30px 20px; background: #ffffff;">
            <p style="font-size: 16px; line-height: 1.6; color: #4b5563; margin-bottom: 20px;">
              ...
              Thank you for your purchase! We've received your payment of <strong>${
                order.currency
              } ${order.amount}</strong> and your order is being processed.
            </p>
            ...
            <div style="background: #f8fafc; border-radius: 8px; padding: 20px; margin: 20px 0; border: 1px solid #e2e8f0;">
              ...
              ${order.order?.OrderItems.map(
                ...
                <div style="display: flex; margin: 15px 0; align-items: center;">
                  ...
                  <div style="flex: 1;">      
                    <p style="margin: 0 0 5px; font-weight: 600; color: #1e293b; font-size: 15px;">${
                      item.Product.name
                    }</p>
                   
                    <p style="margin: 0 0 3px; color: #64748b; font-size: 14px;">Qty: ${
                      item.quantity
                    }</p>
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 30px; margin: 25px 0; width: 100%;">
              <div style="flex: 1; min-width: 200px;">
                ...
                <div style="background: #f8fafc; border-radius: 6px; padding: 12px; font-size: 14px;">
                  <p style="margin: 0 0 5px; font-weight: 500;">${
                    order.user?.name
                  }</p>
                  <ul style="padding-left: 20px; margin: 0; color: #4b5563; line-height: 1.6;">
              ...
              <div style="flex: 1; min-width: 200px;">
                ...
                <div style="background: #f8fafc; border-radius: 6px; padding: 12px; font-size: 14px;">
                  ...
                  <p style="margin: 0; color: #64748b;">Paid on ${new Date(
                    order.createdAt
